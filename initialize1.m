...
trj.data = xlsread([prj.id,' ИД.xls'],'Траектория');
...
trj.massdata = xlsread([prj.id,' ИД.xls'],'Массовые центровочные хар-ки');
% Массовые центровочные характеристики
% 1: m, кг - масса
% 2: Jzz, кг м2 - осевой момент инерции 
% 3: Cm, % - относительное полоэение центра масс
trj.aerodata = xlsread([prj.id,' ИД.xls'],'Аэродинамические хар-ки');
% Массовые центровочные характеристики
% 1: М, б/р - число Маха
% 2: cya, 1/град
% 3: сyaalpha, 1/град
...
%% Строим графики
title('Графики изменения коэффициентов уравнений возмущенного движения')
